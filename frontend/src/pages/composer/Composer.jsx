  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${base}/projects?clientId=${encodeURIComponent(invoice.client)}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      /*
       * IMPORTANT:
       * Only keep projects belonging to the selected client.
       */
      projects = projects
        .map((project) => ({
          ...project,
        ...
        .filter(
          (project) =>
            project.id &&
            String(project.clientId) === String(invoice.client)
        );
