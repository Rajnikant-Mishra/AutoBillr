...
/*
  ...
  If this file itself is named TeamPermissions.jsx,
  DO NOT import TeamPermissions from "./TeamPermissions".

  The permissions UI below is already included directly.
*/
